...
Every user automatically has the 'self' role on themselves, for the purposes of permit expressions only. (has_role? 'self' will fail) e.g. permit 'admin or (self of user)' for Users#show_private_info
